...
<section class="mission-section" bind:this={section} class:visible>
    <div class="content">
        <div class="text-col">
            ...
            <p class="desc">
                The old world is gone. The corporations have taken everything.
                But in the shadows, waiting for the signal, are the <strong
                    >Walkers</strong
                >. We are the glitch in their perfect system. The anomaly they
                cannot patch.
            </p>
            <p class="desc">
                Your skills are your weapon. Your code is your ammunition. Join
                the resistance and reclaim the digital frontier.
            </p>
        </div>
